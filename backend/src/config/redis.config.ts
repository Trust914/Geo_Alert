...
const REDIS_PORT = Number(checkIfDefined(getEnvVariable("REDIS_PORT"), "REDIS_PORT"));
const REDIS_PASSWORD = checkIfDefined(getEnvVariable("REDIS_PASSWORD"), "REDIS_PASSWORD");
