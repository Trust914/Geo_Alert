...
const FRONT_END_DOMAIN = APP_ENV === "development" ? FRONT_END_DOMAIN_DEV : APP_ENV === "staging" ? FRONT_END_DOMAIN_STAGING : FRONT_END_DOMAIN_PROD;
...
export const serverConfig = {
  ...
  cors: {
    ...
    frontendDoman: FRONT_END_DOMAIN,
    localhost: LOCALHOST,
  },
