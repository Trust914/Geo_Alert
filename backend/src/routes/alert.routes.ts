...
import {
  ...
  cancelAlertSchema,
  createAlertSchema,
  estimateRecipientsSchema,
} from "../validators/alert.validators.js";
import {
  bffAuthenticate,
...
router.get(
  ...
  requireAlertWriteAccess,
  validate(alertIdSchema),
  AlertController.previewAlert
);

router.post(
  "/estimate-recipients",
  requireAlertWriteAccess,
  validate(estimateRecipientsSchema),
  AlertController.estimateRecipients
);
