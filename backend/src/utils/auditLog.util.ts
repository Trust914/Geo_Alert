...
export const createAuditLog = async (userId: string | null, action: ActionType, entityType: EntityType, entityId: string, changes?: any, ipAddress?: string, userAgent?: string): Promise<void> => {
  try {
